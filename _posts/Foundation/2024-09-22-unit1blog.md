...
<br>
constraints:Limits that a data type can hold. Ex: integers and doubles have a maximum and minimum value they can store, beyond which the program can't handle them properly. Integer limit is 2,147,483,647
